      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 items-center px-4'>
        ...
        <div className="flex flex-col items-center">
          ...
          <ul className='text-white flex flex-col items-center w-full gap-4'>
            ...
            <button className='relative mx-auto my-4 w-[225px] h-9 bg-white text-black rounded cursor-pointer overflow-hidden group font-bold uppercase flex items-center justify-center'>
