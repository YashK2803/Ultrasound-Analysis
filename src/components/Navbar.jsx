...
const Navbar = () => {
    ...
    return(
        <div className='text-white flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4'>
            ...
            <div className={`fixed top-0 left-0 w-[60%] h-full bg-[#000300] border-r border-r-gray-900 transform ${nav ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out block md:hidden`}>
            ...
            <ul className='uppercase font-semibold p-4'>
                ...
                <li className='py-4 cursor-pointer whitespace-nowrap'>Login</li>
            </ul>
            </div>
        </div>
    )
